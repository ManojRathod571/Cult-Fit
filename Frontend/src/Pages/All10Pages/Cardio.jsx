...
function Cardio() {
  ...
  const handleFilter = (el) => {
    dispatch(getData("cardio", page, el));
  };

  const handleLH = (asc) => {
    dispatch(getData("cardio", page, "", asc));
  };

  const handleHL = (desc) => {
    dispatch(getData("cardio", page, "", desc));
  };
  ...
  const hanldeOff = (off) => {
    dispatch(getData("cardio", page, "", "", "", off));
  };

  const handleChange = (e) => {
    setValue(e.target.value);
    dispatch(getInputData("cardio", page, value));
  };
  return isLoading ? (
    <Loader />
  ) : (
